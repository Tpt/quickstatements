...
namespace QuickStatements\OAuth;
...
use QuickStatements\OAuth\Token\AccessToken;
use QuickStatements\OAuth\Token\ConsumerToken;
use QuickStatements\OAuth\Token\RequestToken;
use QuickStatements\OAuth\Token\Token;
